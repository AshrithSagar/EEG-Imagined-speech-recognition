...
karaone = KaraOneDataLoader(
    data_dir="/Users/ashrith/Documents/Hons/Datasets/KaraOne/EEG_data",
    subjects=subjects[:1],
    sampling_freq=1000,
...
karaone.extract_features(
    features_dir="/Users/ashrith/Documents/Hons/Datasets/KaraOne/simple_features",
    epoch_type="thinking",
)

features = karaone.load_features(epoch_type="thinking", verbose=True)

flattened_features, flattened_labels = karaone.flatten(features, labels, verbose=True)
...
model_dir = "/Users/ashrith/Documents/Hons/Repos/_/EEG-Imagined speech recognition/files/KaraOne/SVM"
